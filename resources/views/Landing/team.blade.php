        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/rizal.png" alt=""></div>
									<div class="info-meta">
										<h6 class="name">M Rizal Kurniawan</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/hamdi.jpeg" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Hamdi Musaad</h6>
            ...
            <div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/ogy.jpeg" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Ogy Winenriandhika   </h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/ica.jpeg" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Ica Atarita</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/emil.jpg" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Emil Enan</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/irvan.jpeg" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Irvan Aryanto</h6>
										<span>Data Analyst/Data Scientist
                    </span>
									</div>
								</div>
								<div class="hover-content">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/hanum.JPG" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Luluk Lutfiya Hanum</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/wim.jpg" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Wim Sonevel</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/dany.jpeg" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Danny As'ary</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/faik.jpeg" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Achmad Faik F</h6>
										<span> Senior Full Stack Programmer</span>
									</div>
								</div>
								<div class="hover-content">
									<ul>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/alfan.jpg" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Alfan Ghinan R</h6>
										<span>Senior Mobile Programmer</span>
									</div>
								</div>
								<div class="hover-content">
									<ul>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/alibi.jpeg" alt=""></div>
									<div class="info-meta">
										<h6 class="name">M. Dhofir Alibi</h6>
										<span>Senior Android Programmer</span>
									</div>
								</div>
								<div class="hover-content">
									<ul>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/fikri.JPG" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Ahmad Dzul Fikri</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/abdan.jpeg" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Abdan Syakuro</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/alif-nur.jpeg" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Alif Nur I</h6>
										<span>Senior Full Stack Programmer</span>
									</div>
								</div>
								<div class="hover-content">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/naufal.JPG" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Naufaldi Rafif S</h6>
										<span>Senior Frontend Programmer</span>
									</div>
								</div>
								<div class="hover-content">
									<ul>
							...
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/galih.jpg" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Galih Prasetyo</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/darmawan.jpeg" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Darmawan Stiawan Afrizon</h6>
										<span>Videographer & Editing</span>
									</div>
								</div>
								<div class="hover-content">
									<ul>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/eldo.jpg" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Eldo Alvianto</h6>
										<span>Videographer & Editing</span>
									</div>
								</div>
								<div class="hover-content">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-team-member">
								<div class="wrapper pos-r">
									<div class="img-box"><img src="images/team/vetuwa.jpg" alt=""></div>
									<div class="info-meta">
										<h6 class="name">Vetuwa</h6>
										<span>Videographer & Editing</span>
									</div>
								</div>
								<div class="hover-content">
