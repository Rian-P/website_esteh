					...
					<div class="masnory-blog-wrapper">
						...
						<div class="isotop-item economy marketing">
							...
							<div class="blog-post-block-two mb-75 md-mb-50">
								<div class="img-holder"><img src="{{asset('storage/images/blog/'.$item->image)}}" alt=""></div>
								<div class="post">
									<ul class="post-info">
									...
									<a href="" class="read-more inline-button-one">Continue Reading</a>
								</div> <!-- /.post -->
						...
						<div class="isotop-item economy">
							...
							<div class="blog-post-block-two mb-75 md-mb-50">
								...
								<ul class="post-info">
									...
									<h4><a href="{{ route('blogdetail') }}">{{ $item->title }}</a></h4>
									<p>{{ $item->description }}</p>
									<a href="blogdetail" class="read-more inline-button-one">Continue Reading</a>
