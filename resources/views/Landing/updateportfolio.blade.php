            ...
            <div class="row m-3 items-center">
              ...
              <div class="col-sm-6">
                <div class=" float-sm-right">
                  <a href="/formPortfolio"><button type="submit" class="btn btn-success   flex" value="Submit">Tambah Portfolio + </button></a>
                  <a href=""><button type="submit" class="btn btn-success   flex" value="Submit">View Portfolio</button></a>
                </div>
              </div>
              </div>            
              <!-- /.card-header -->
                    ...
                    <tr class="text-center">
                      ...
                      <td>
                        <div class="items-center">
                          <a href="/editportfolio/{{ $row->id }}"><button type="button" class="btn btn-warning text-white " >Edit</button></a>
                          
                          <a href="/delete/{{$row->id}}"><button type="button" class="btn btn-danger " value="Submit">Hapus</button></a>
                        </div>
                      </td>                       
                    </tr>
                     @endforeach
