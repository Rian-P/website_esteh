		...
		<div class="main-page-wrapper">
			...
			<div class="text-inner-banner-one pos-r">
				...
				<div class="container">
					...
					<p class="sub-heading">Kami memberikan layanan dengan sepenuh hati, diinisiasi oleh anak-anak muda kreatif yang telah berpengalaman menyelesaikan berbagai proyek dan terus berkreasi untuk turut larut dalam menghadirkan teknologi terkini yang mengesankan.</p>
				</div>
						...
						<div class="col-md-6">
							<div class="service-classic-block mb-90 md-mb-60">
								...
								<div class="text-holder">
									...
									<p>Desain dan pengalaman pengguna merupakan kesan awal yang sangat penting dalam membangun bisnis. Bersama Esteh Creative, kami memberikan dukungan serta garansi desain dan pengalaman pengguna untuk pelayanan yang terbaik.</p>
								</div> <!-- /.text-holder -->
							</div> <!-- /.service-classic-block -->
						</div>
						<div class="col-md-6">
            ...
            <div class="col-md-6">
							<div class="service-classic-block mb-90 md-mb-60">
								...
								<div class="text-holder">
									...
									<p>Kondisi startup yang masih mencari model bisnis yang tepat sangat perlu untuk memvalidasi ide bisnisnya. Minimum Viable Product dan Prototyping adalah salah satu metode yang tepat untuk memvalidasi ide dalam waktu yang lebih efektif dan efisien.</p>
								</div> <!-- /.text-holder -->
							</div> <!-- /.service-classic-block -->
            </div>
            <div class="col-md-6">
							<div class="service-classic-block mb-90 md-mb-60">
								...
								<div class="text-holder">
									...
									<p>Produk atau layanan yang bagus adalah yang berada pada market yang tepat dan memiliki engagement yang kuat. Maka perlu ada strategi untuk membangun brand activation sekaligus brand awareness yang sesuai dengan market yang dituju.</p>
								</div> <!-- /.text-holder -->
							</div> <!-- /.service-classic-block -->
            </div>
            <div class="col-md-6">
							<div class="service-classic-block mb-90 md-mb-60">
								...
								<div class="text-holder">
									...
									<p>Data sudah menjadi aset yang begitu berharga bagi perkembangan bisnis. Namun harus melalui tahap pemrosesan terlebih dahulu agar mendapatkan insight yang reliable dan valid. Data Mining, Artificial Intelligent, Machine Learning serta Data Science adalah beberapa pendekatan yang seringkali digunakan untuk meningkatkan daya guna data.</p>
								</div> <!-- /.text-holder -->
							</div> <!-- /.service-classic-block -->
						</div>
						<div class="col-md-6">
			...
			<div class="testimonial-section-classic style-one pos-r md-pt-40 md-pb-200">
				...
				<div class="container">
					<div class="theme-title-one text-center">
						...
						<h2 class="main-title underline"><span>Kata Mereka</span><br> <span>Mengenai Kami.</span></h2>
					</div> <!-- /.theme-title-one -->
			...
			</div> <!-- /.testimonial-section-classic -->
			...
			<footer class="theme-footer-one pt-130">
				  ...
				  <div class="container">
					<div class="row">
					  ...
					  <div class="col-lg-3 col-lg-2 col-sm-6 col-12 footer-information">
						...
						<ul>
							<li>
								<a href="https://www.facebook.com/esteh.creative/" target="_blank"
								><i class="fa fa-facebook" aria-hidden="true"></i
								></a>
							</li>
							<li>
								<a href="https://twitter.com/estehcreative" target="_blank"
								><i class="fa fa-twitter" aria-hidden="true"></i
								></a>
							</li>
							<li>
								<a href="https://www.linkedin.com/company/esteh-creative/" target="_blank"
				...
				<div class="container">
					<div class="bottom-footer-content">
					  <p>&copy; 2013 - <script>document.write(new Date().getFullYear())</script> Copyright all right reserved</p>
