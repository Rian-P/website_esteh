    ...
    <body>
       ...
       -->
            <div class="our-portfolio">
                <div class="container">
                    <div id="filter-for-classicTwo" class="cbp-l-filters-alignCenter filter-menu">
                                ...
                                <div class="cbp-item-wrapper">
                                    <div class="cbp-caption">
                                        <div class="cbp-caption-defaultWrap">
                                            ...
                                            <img src="{{ asset('storage/image/portofolio/' . $item->portfolio) }}"
                                                alt="" />
                                        </div>
                                        <div class="cbp-caption-activeWrap">
                                            <div class="cbp-l-caption-alignCenter">
                                                <div class="cbp-l-caption-body">
                                                    <a href="ajax-pages/portfolio-rpi.html"
                                                        class="cbp-singlePage cbp-l-caption-buttonLeft"
                                                        rel="nofollow">More Info</a>
                                                    <a href="images/portofolio/thumb/privat-big.jpeg"
                                                        class="cbp-lightbox cbp-l-caption-buttonRight"
                                                        data-title="Private Tutoring App <br> Merupakan platform yang ditujukan kepada para siswa maupun mahasiswa yang membutuhkan waktu lebih untuk belajar.">View
                                                        Larger</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="cbp-caption">
                                    ...
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                                                <a href="ajax-pages/portfolio-rpi.html"
                                                    class="cbp-singlePage cbp-l-caption-buttonLeft" rel="nofollow">More
                                                    Info</a>
                                                <a href="images/portofolio/thumb/midwife-big.jpeg"
                                                    class="cbp-lightbox cbp-l-caption-buttonRight"
                                                    data-title="Midwife App <br> Merupakan platform yang dimanfaatkan untuk mewadahi kebutuhan pasien yang membutuhkan layanan bidan.">View
                                                    Larger</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                                                <a href="ajax-pages/portfolio-rpi.html"
                                                    class="cbp-singlePage cbp-l-caption-buttonLeft" rel="nofollow">More
                                                    Info</a>
                                                <a href="images/portofolio/thumb/human-app-big.jpeg"
                                                    class="cbp-lightbox cbp-l-caption-buttonRight"
                                                    data-title="Human Resource App <br> Merupakan platform yang dimanfaatkan untuk mewadahi kebutuhan para pahlawan devisa yang ada di luar negeri.">View
                                                    Larger</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="cbp-item-wrapper">
                                <div class="cbp-caption">
                                    ...
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                                                <a href="ajax-pages/portfolio-compro.html"
                                                    class="cbp-singlePage cbp-l-caption-buttonLeft" rel="nofollow">More
                                                    Info</a>
                                                <a href="images/portofolio/thumb/lms-web-big.jpeg"
                                                    class="cbp-lightbox cbp-l-caption-buttonRight"
                                                    data-title="LMS for Web <br> Dikembangkan dengan berbagai fitur yang didesain khusus untuk menunjang kegiatan belajar mengajar berbasis website.">View
                                                    Larger</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                                                <a href="ajax-pages/portfolio-rpi.html"
                                                    class="cbp-singlePage cbp-l-caption-buttonLeft" rel="nofollow">More
                                                    Info</a>
                                                <a href="images/portofolio/thumb/medical-big.jpeg"
                                                    class="cbp-lightbox cbp-l-caption-buttonRight"
                                                    data-title="Medical Services <br> Merupakan platform bagi pasien yang memerlukan perawatan secara harian maupun berkelanjutan.">View
                                                    Larger</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                                                <a href="ajax-pages/portfolio-rpi.html"
                                                    class="cbp-singlePage cbp-l-caption-buttonLeft" rel="nofollow">More
                                                    Info</a>
                                                <a href="images/portofolio/thumb/muslim-app-big.jpeg"
                                                    class="cbp-lightbox cbp-l-caption-buttonRight"
                                                    data-title="Muslim Life App <br> Merupakan platform bagi para umat muslim yang di setiap kehidupannya tidak lupa melakukan ibadah-ibadah yang wajib dilakukannya.">View
                                                    Larger</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                                                <a href="ajax-pages/portfolio-compro.html"
                                                    class="cbp-singlePage cbp-l-caption-buttonLeft" rel="nofollow">More
                                                    Info</a>
                                                <a href="images/portofolio/thumb/compro-mekkah-big.jpeg"
                                                    class="cbp-lightbox cbp-l-caption-buttonRight"
                                                    data-title="Company Profile Mekkah <br> Dikembangkan dengan berbagai fitur yang didesain khusus untuk menunjang <br>perusahaan dalam hal branding. <br> Dilengkapi berbagai fitur yang bisa dicustomize sesuai kebutuhan perusahaan. ">View
                                                    Larger</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                                                <a href="ajax-pages/portfolio-rpi.html"
                                                    class="cbp-singlePage cbp-l-caption-buttonLeft" rel="nofollow">More
                                                    Info</a>
                                                <a href="images/portofolio/thumb/food-big.jpeg"
                                                    class="cbp-lightbox cbp-l-caption-buttonRight"
                                                    data-title="On Demand for Food <br> Merupakan platform bagi para pencinta makanan yang tidak perlu lagi ke tempat makan,<br>dengan menggunakan mobile phone makanan sudah bisa sampai.">View
                                                    Larger</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                                                <a href="ajax-pages/portfolio-rpi.html"
                                                    class="cbp-singlePage cbp-l-caption-buttonLeft" rel="nofollow">More
                                                    Info</a>
                                                <a href="images/portofolio/thumb/clinic-big.jpeg"
                                                    class="cbp-lightbox cbp-l-caption-buttonRight"
                                                    data-title="Clinic Mobile App <br> Merupakan platform yang dibuat untuk menjalankan layanan-layanan klinik via digital yang berbasis mobile.">View
                                                    Larger</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                                                <a href="ajax-pages/portfolio-rpi.html"
                                                    class="cbp-singlePage cbp-l-caption-buttonLeft" rel="nofollow">More
                                                    Info</a>
                                                <a href="images/portofolio/thumb/lms-big.jpeg"
                                                    class="cbp-lightbox cbp-l-caption-buttonRight"
                                                    data-title="Corparate Learning Management System <br> Merupakan platform yang bertujuan untuk menigkatkan skill dari para karyawan corporate melalui sistem pembelajaran.">View
                                                    Larger</a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 col-12 footer-about-widget">
                                <a href="index.html" class="logo">
                                    <img src="images/logo/logo-esteh.png" style="margin-left: -7px;" class="logo-footer"
                                        alt="" />
                                </a>
                            ...
                            <div class="col-lg-3 col-lg-3 col-sm-6 col-12 footer-list">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="service.html"> Research & Market Analysis </a>
                                    </li>
                                    <li><a href="service.html">Startup MVP & Prototyping </a></li>
                                    <li><a href="service.html">Campaign Digital Strategist</a></li>
                                    <li><a href="service.html">Analysis Data</a></li>
                                    <li><a href="service.html">Video Production</a></li>
                                    <li><a href="service.html">Social Media Campaign</a></li>
                                </ul>
                            </div>
                            <!-- /.footer-recent-post -->
                            <div class="col-lg-3 col-sm-6 col-12 footer-list">
                                ...
                                <ul>
                                    ...
                                    <li><a href="portofolio.html">Work Portfolio</a></li>
                            ...
                            <div class="col-lg-3 col-lg-2 col-sm-6 col-12 footer-information">
                                ...
                                <p>
                                    STC Senayan Lt. 2 Ruang 35 JL. Asia Afrika Pintu IX, Gelora,
                                    <br />
                                    Tanah Abang, Kota Jakarta Pusat, DKI Jakarta Kode Pos. 10270
                                </p>
                                <strong>Malang Office:</strong>
                                <p>
                                    Perumahan Gurami Indah Tahap 2 Kav. V
                                    <br />
                                    Kelurahan Tasikmadu, Kec. Lawokwaru, Malang, 65142
                                </p>
                                <ul>
                                    <strong>Blitar Office:</strong>
                                    <p>
                                        Jl. A.Yani No. 29, RT 04 RW 02
                                        <br />
                                        Ds. Kesamben, Kec. Kesamben, Kab. Blitar, Jawa Timur, Pos 66191
                                    </p>
                                    <ul>
                                        <li>
                                            <a href="https://www.facebook.com/esteh.creative/" target="_blank"><i
                                                    class="fa fa-facebook" aria-hidden="true"></i></a>
                                        </li>
                                        <li>
                                            <a href="https://twitter.com/estehcreative" target="_blank"><i
                                                    class="fa fa-twitter" aria-hidden="true"></i></a>
                                        </li>
                                        <li>
                                            <a href="https://www.linkedin.com/company/esteh-creative/" target="_blank"><i
                ...
                <div class="container">
                    <div class="bottom-footer-content">
                        <p>&copy; 2013 -
                            ...
                            </script> Copyright all right reserved
                        </p>
                        <p>Esteh Creative - PT. Sekar Tekno Kreatif</p>
                    </div>
                    <!-- /.bottom-footer -->
                </div>
            </footer>
